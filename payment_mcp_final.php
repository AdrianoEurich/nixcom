<?php
// Endpoint final para MCP com QR Codes reais
...
error_log("PAYMENT_MCP_FINAL: Requisição recebida - " . date('Y-m-d H:i:s'));
...
// Dados do pagamento
$amount = 6.00;
$subscriptionId = 'mcp_final_' . time();
...
try {
    ...
    echo json_encode([
        ...
        'payment_id' => 'mcp_final_payment_' . time(),
