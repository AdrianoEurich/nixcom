...
<div class="card shadow mb-4">
    <!-- Título da Página -->
    <!-- ATUALIZAÇÃO AQUI: Cor de fundo alterada para #6A5ACD usando estilo inline -->
    <div class="card-header py-3 text-white" style="background-color: #6A5ACD;">
        <h5 class="m-0"><i class="fas fa-eye me-2"></i>VISUALIZAR ANÚNCIO</h5>
    </div>
